...
!else
InstallDir $PROGRAMFILES\e4CoinCore
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
VIAddVersionKey ProductName "e4Coin Core"
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\e4coin-qt
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\e4Coin Core (testnet, -bit).lnk" "$INSTDIR\e4coin-qt" "-testnet" "$INSTDIR\e4coin-qt" 1
    ...
    WriteRegStr HKCR "e4coincore" "URL Protocol" ""
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\e4coin-qt
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\e4Coin Core (testnet, -bit).lnk"
    Delete /REBOOTOK "$SMSTARTUP\e4Coin.lnk"
