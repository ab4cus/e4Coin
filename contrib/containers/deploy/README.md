...
official/supported Docker Images found at https://hub.docker.com/r/ab4cus/e4coin/
...
**NOTE: Please update the image description at https://hub.docker.com/r/e4coin/e4coind-develop/ when changing the above text**