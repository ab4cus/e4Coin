# Linearize
Construct a linear, no-fork, best version of the e4Coin blockchain. The scripts
...
JSON-RPC server. Running `e4coind` or `e4coin-qt -server` will be sufficient.
...
* `input`: e4coind blocks/ directory containing blkNNNNN.dat
