...
Arguments:
    <base_directory> - The base directory of a e4Coin Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The e4Coin Core developers'
...
Arguments:
    <base_directory> - The base directory of e4Coin Core source code repository.
"""
...
Arguments:
    <file> - A source file in the e4Coin Core repository.
"""
