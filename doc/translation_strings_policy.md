...
This document provides guidelines for internationalization of the e4Coin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `e4coin_en.ts` remains unchanged.
