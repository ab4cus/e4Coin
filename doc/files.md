...
* e4coin.conf: contains configuration settings for e4coind or e4coin-qt
* e4coind.pid: stores the process id of e4coind while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by e4coind or e4coin-qt
