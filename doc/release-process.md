...
* Update translations, see [translation_process.md](https://github.com/e4cash/e4coin/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/e4cash/e4coin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/e4cash/e4coin.git
...
- Detached signatures will then be committed to the [e4coin-detached-sigs](https://github.com/e4cash/e4coin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Optionally Discord, twitter, reddit /r/e4cash, ... but this will usually sort out itself
  ...
  - Create a [new GitHub release](https://github.com/e4cash/e4coin/releases/new) with a link to the archived release notes.
