...
git clone https://github.com/e4coinpay/e4coin
...
```bash
    ...
    From https://github.com/e4coinpay/e4coin
...
[e4coin/gitian.sigs](https://github.com/e4coinpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
