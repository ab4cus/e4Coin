...
class e4coinTestFramework(object):
    ...
    def main(self):
        ...
        if not self.options.noshutdown:
            ...
            print("Note: e4coinds were not stopped and may still be running")
...
class e4CoinTestFramework(e4coinTestFramework):
...
class ComparisonTestFramework(e4coinTestFramework):
    ...
    def add_options(self, parser):
        parser.add_option("--testbinary", dest="testbinary",
                          default=os.getenv("E4COIND", "e4coind"),
