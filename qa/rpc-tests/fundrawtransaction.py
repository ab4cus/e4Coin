...
class RawTransactionsTest(e4coinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid e4coin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid e4coin address" in e.error['message'])
