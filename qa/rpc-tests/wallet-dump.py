...
class WalletDumpTest(e4coinTestFramework):
    ...
    def run_test (self):
        ...
        # TODO clarify if we want the behavior that is tested below in e4Coin (only when HD seed was generated and not user-provided)
