...
class LLMQCoinbaseCommitmentsTest(e4CoinTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as e4CoinTestFramework doesn't support this atm)
