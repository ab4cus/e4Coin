...
official/supported Docker Images found at https://hub.docker.com/r/e4coinpay/e4coind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/e4coinpay/e4coind-develop/ when changing the above text**