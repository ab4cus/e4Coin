...
#ifndef E4COIN_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
#define E4COIN_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
...
#endif // E4COIN_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
