...
#ifndef E4COIN_QT_OPTIONSMODEL_H
#define E4COIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for e4coin client.
...
#endif // E4COIN_QT_OPTIONSMODEL_H
