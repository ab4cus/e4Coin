...
#include "config/e4coin-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formate4coinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + e4coinUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formate4coinURI(info));
}
