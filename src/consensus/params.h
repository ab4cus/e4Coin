...
#ifndef E4COIN_CONSENSUS_PARAMS_H
#define E4COIN_CONSENSUS_PARAMS_H
...
// See https://github.com/e4coinpay/dips/blob/master/dip-0006.md for more details
struct LLMQParams {
    LLMQType type;
...
#endif // E4COIN_CONSENSUS_PARAMS_H
