...
enum ServiceFlags : uint64_t {
    ...
    // e4Coin Core does not support this but a patch set called Bitcoin XT does.
...
enum GetDataMsg {
    ...
    MSG_TXLOCK_VOTE = 5,
    MSG_SPORK = 6,
    /* 7 - 15 were used in old e4Coin versions and were mainly budget and MN broadcast/ping related*/
    MSG_DSTX = 16,
