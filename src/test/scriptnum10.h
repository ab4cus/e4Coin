...
#ifndef E4COIN_TEST_SCRIPTNUM10_H
#define E4COIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from e4coin Core 0.10.0, for cross-comparison.
 */
public:
