...
#define BOOST_TEST_MODULE e4Coin Test Suite

#include "test_e4coin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_e4coin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
