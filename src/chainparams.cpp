...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("MHQCAQEEIEMoMxl835UpDFqan13EiV7FXNClUw71IXR7/t29dsLjoAcGBSuBBAAKoUQDQgAEDXK41d3ygjFLQ++PII36sH1SuVNVaFb87+7QHkJ9v/TE7+AFSfSYk+QIPU5ljNqCHbOJGdWLXjNZ8ytQAWmGCw==") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 12 * 60 * 60; // e4Coin: 12 horas
        consensus.nPowTargetSpacing = 1 * 30; // e4Coin: 0.5 minutes
        ...
        /*
        consensus.hashGenesisBlock = genesis.uint256("0x01")
        ...
        */
        ...
        // e4Coin addresses start with 'X'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,33);
        // e4Coin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,33);
        // e4Coin private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,204);
        // e4Coin BIP32 pubkeys start with 'xpub' (e4coin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // e4Coin BIP32 prvkeys start with 'xprv' (e4coin defaults)
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("e4coin.io",  "testnet-seed.e4coin.io"));
        vSeeds.push_back(CDNSSeedData("e4cash.net", "test.dnsseed.e4cash.net"));

        // Testnet e4Coin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet e4Coin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (e4coin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet e4Coin BIP32 pubkeys start with 'tpub' (e4coin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet e4Coin BIP32 prvkeys start with 'tprv' (e4coin defaults)
...
public:
    CDevNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("e4coin.org",  "devnet-seed.e4coin.org"));
...
public:
    CRegTestParams() {
        ...
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (e4coin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest e4Coin BIP32 pubkeys start with 'tpub' (e4coin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest e4Coin BIP32 prvkeys start with 'tprv' (e4coin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
