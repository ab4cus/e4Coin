 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1579890311, nBits=1e0ffff0, nNonce=286737, vtx=1)
...
{
    const char* pszTimestamp = "The Times 14/Feb/2019 JPMorgan Chase Moves to Be First Big U.S. Bank With Its Own Crypto";
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 650000; 
        ...
        consensus.nPowTargetSpacing = 1 * 60; // e4Coin : 0.8 minutos (48 segundos)
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nWindowSize = 4;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nWindowSize = 4;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nWindowSize = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nThreshold = 3; 

        // Deployment of DIP0008
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nStartTime = 0; 
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nTimeout = 999999999999ULL; 
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nWindowSize = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nThreshold = 3; 
        ...
        consensus.defaultAssumeValid = uint256S("0x0000088ff8aac3baf11bca61b2569dd0918f61c249f5c7d87b67b53dceaec234"); 
        ...
        genesis = CreateGenesisBlock(1579890311, 256522, 0x1e0ffff0, 1, 500 * COIN);
        //genesis = CreateGenesisBlock(1579890321, 1756858, 0x1e0ffff0, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // calculate main genesis block
        //consensus.hashGenesisBlock = uint256S("0x00");
        //consensus.hashGenesisBlock = uint256S("0x0000088ff8aac3baf11bca61b2569dd0918f61c249f5c7d87b67b53dceaec234");
        ...
        // print hash genesis
        //printf ("e4Coin main hashGenesisBlock: %s\n",
        //    consensus.hashGenesisBlock.ToString().c_str());

        // print hash merkle
        //printf ("e4Coin main hashMerkleRoot: %s\n",
        //    genesis.hashMerkleRoot.ToString ().c_str());

        assert(consensus.hashGenesisBlock == uint256S("0x0000088ff8aac3baf11bca61b2569dd0918f61c249f5c7d87b67b53dceaec234"));
        assert(genesis.hashMerkleRoot == uint256S("f714374caab0d180aee7e758141e5e37afa376355160f0ddddffb1e229434297"));
        ...
        // e4Coin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // e4Coin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // e4Coin BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"EWK3J6aRhPiAqiAp9wcf8eNt9QYYo6yQHE"};
        nMinSporkKeys = 1;
        ...
        checkpointData = (CCheckpointData) {
            ...
            //(  0, uint256S("0x0000088ff8aac3baf11bca61b2569dd0918f61c249f5c7d87b67b53dceaec234"))
            (  0, uint256S("0x001"))
        };

        chainTxData = ChainTxData{
            1579890311, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000d5e66d2e77cb0bbcbd592ee16cee9c845575e1bbc0f76cff36d5af6f984"); 
        ...
        genesis = CreateGenesisBlock(1579890316UL, 1376714, 0x1e0ffff0, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        // print hash genesis
        //printf ("e4Coin test net hashGenesisBlock: %s\n",
        //    consensus.hashGenesisBlock.ToString().c_str());

        // print hash merkle
        //printf ("e4Coin test net hashMerkleRoot: %s\n",
        //    genesis.hashMerkleRoot.ToString ().c_str());

        assert(consensus.hashGenesisBlock == uint256S("0x00000d5e66d2e77cb0bbcbd592ee16cee9c845575e1bbc0f76cff36d5af6f984"));
        assert(genesis.hashMerkleRoot == uint256S("f714374caab0d180aee7e758141e5e37afa376355160f0ddddffb1e229434297"));
        ...
        // Testnet e4Coin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet e4Coin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet e4Coin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"4ULZg5kVfwJmo3qBvTtZ2KPXL7BzUzFXXe"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            //(    0, uint256S("0x00000d5e66d2e77cb0bbcbd592ee16cee9c845575e1bbc0f76cff36d5af6f984"))
            (  0, uint256S("0x001"))
        };

        chainTxData = ChainTxData{
            1579890316, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0xb6df22a01047eee7edfe7dfe44e758e090d20df141842c7f320f79e6189baac0"));
        assert(genesis.hashMerkleRoot == uint256S("f714374caab0d180aee7e758141e5e37afa376355160f0ddddffb1e229434297"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0xb6df22a01047eee7edfe7dfe44e758e090d20df141842c7f320f79e6189baac0"))
...
public:
    CRegTestParams() {
        ...
        // print hash genesis
        //printf ("e4Coin regtest net hashGenesisBlock: %s\n",
        //    consensus.hashGenesisBlock.ToString().c_str());

        // print hash merkle
        //printf ("e4Coin regtest net hashMerkleRoot: %s\n",
        //    genesis.hashMerkleRoot.ToString ().c_str());
        ...
        // privKey: 5ZvboWTD8MdjfQcA85KzTvUB4f1gcSHGDPVrVYKkdJxU7kVkJkJ
        vSporkAddresses = {"4bCLWmsCfkJ489WxQybKfEc43EXyssbp1H"};
        nMinSporkKeys = 1;
        ...
        // Regtest e4Coin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,8);
        // Regtest e4Coin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,9);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,136);
        // Regtest e4Coin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest e4Coin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest e4Coin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
